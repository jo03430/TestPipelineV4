...
namespace TestPipelineV4.Configure.Swagger
{
        ...
        : IConfigureNamedOptions<SwaggerGenOptions>
    {
        ...
        public void Configure(SwaggerGenOptions options)
        {
            ...
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestPipelineV4.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestPipelineV4.Domain.xml"));

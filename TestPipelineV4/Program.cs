...
using TestPipelineV4.Domain;
using TestPipelineV4.Domain.Auth;
...
using TestPipelineV4.Configure.Swagger;
...
builder.Host.ConfigureContainer<ContainerBuilder>(containerBuilder =>
{
    ...
    containerBuilder.RegisterModule<TestPipelineV4DomainAutofacRegistration>();
});
...
app.UseSwaggerUI(options =>
{
    ...
    options.DocumentTitle = environment.IsProduction() ? "TestPipelineV4 API" : $"{environment.EnvironmentName} - TestPipelineV4 API";
});
